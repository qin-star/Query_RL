...
# GPU配置：通过CUDA_VISIBLE_DEVICES环境变量控制
...
python3 -m verl.trainer.main_ppo \
    ...
    +rag.endpoints.chat_8b=/rag/chat_8b \
    +rag.endpoints.chat=/rag/chat \
    +rag.connection.timeout=30 \
    +rag.connection.max_retries=3 \
    +rag.retrieval.top_k=5 \
    +rag.retrieval.score_threshold=0.7 \
    seed=42
